...
describe('Testa se o componente "Header"', () => {
  ...
  it('Quando clicar no botão do carrinho, o carrinho de compras é renderizado', () => {
    renderWithRedux(<App />);
  ...
  it('Quando clicar no botão de compra, a quantidade de itens no carrinho sobe', async () => {
